...
extern struct obs_source_info adjustments_filter;
...
extern struct obs_source_info voice_match_filter;
...
bool obs_module_load(void)
{
	...
	obs_register_source(&adjustments_filter);
	...
	obs_register_source(&voice_match_filter);
